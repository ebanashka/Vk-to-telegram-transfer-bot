...
def initConfig():
	...
	setCell( "vk_176255953", '-383026113' ) # Пример переадресации ЛС ВК в Telegram
	setCell( "t_-383026113", '176255953' ) # Пример переадресации ЛС ВК в Telegram

	setCell( "vk_308752223", '-383026113' ) # Пример переадресации из чата ВК в Telegram
	setCell( "t_-383026113", '308752223' ) # Пример переадресации из чата ВК в Telegram
